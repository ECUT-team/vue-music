      ...
      <van-swipe :show-indicators="false" @change="onChange" vertical :loop="false">
        <van-swipe-item v-for="(item, index) in videoList" :key="index" class="product_swiper">
          <div class="video_container">
            ...
            ></video>
            <!-- <audio src="@/assets/test.mp3" class="video_box"></audio> -->
            <!-- 封面 -->
  ...
  data() {
    ...
    return {
      ...
      videoList: [
        {
					url:
						"http://m801.music.126.net/20200412203704/f140b025267a58f37c1f4abfe2b6dc1f/jdyyaac/525f/0058/0e08/e512cd13a07213af30889be104707506.m4a",
          cover: "https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=1616338326,2478908045&fm=26&gp=0.jpg", //封面
          tag_image:
            "https://p2.music.126.net/syVzQsUcSC7wQKKIiYnqtA==/7888995929674605.jpg?param=50y50", //作者头像
          fabulous: false, //是否赞过
        ...
        {
					url:
						"http://m10.music.126.net/20200407110032/8de2eba2194db152332626fc2e9bc7cd/ymusic/30df/8cb6/9a02/55f230cca4e0cdbf5d2fd01bfd890784.mp3",
          cover: "https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=3473356962,1692910604&fm=26&gp=0.jpg",
          tag_image:
            "https://p2.music.126.net/j-_SQ3dv_Ge_nXQJ4B2C3Q==/109951164234515971.jpg?param=50y50",
          fabulous: true, //是否赞过
          tagFollow: false, //是否关注过该作者
          author_id: 2, //作者ID
          author: "zby-66",
        ...
        {
          url:
            "http://m10.music.126.net/20200407105136/01337ae52f8f8898d586998231bd0b0d/yyaac/obj/wonDkMOGw6XDiTHCmMOi/1941677162/d674/a146/6699/e8b65b7574b1f94e065d312e52135d6d.m4a",
          cover: "https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=1852151377,3243197855&fm=26&gp=0.jpg",
          tag_image:
